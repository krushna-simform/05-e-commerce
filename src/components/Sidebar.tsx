...
export const Sidebar = () => {
  ...
  return (
    <div>
      ...
      <div
        className={cn(
          "md:flex flex-col items-center fixed left-0 top-0 h-full mt-[69px] pt-10 z-40 bg-white transition-transform duration-300",
          {
      ...
      >
        <div className="flex flex-col items-center w-full h-full md:mt-10">
